...
internal class ArticleArgs(
    ...
    constructor(savedStateHandle: SavedStateHandle, stringDecoder: StringDecoder) :
            this(
                stringDecoder.decodeString(checkNotNull(savedStateHandle[articleTitleArg])),
                stringDecoder.decodeString(checkNotNull(savedStateHandle[articleDescriptionArg])),
                stringDecoder.decodeString(checkNotNull(savedStateHandle[articleContentArg])),
                stringDecoder.decodeString(checkNotNull(savedStateHandle[articleUrlToImageArg])),
            )
}
